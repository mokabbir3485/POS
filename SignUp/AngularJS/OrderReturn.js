...
orderReturnApp.controller('orderReturnController', ['$scope', '$filter', '$http', 'orderReturnService', function ($scope, $http, $filter, orderReturnService) {
    ...
    $scope.Delete = function (OrderReturnObj) {
        orderReturnService.GetAllOrderReturnDetail(OrderReturnObj).then(function (responset) {
            $scope.AddproductList = responset.data;

            orderReturnService.GetAllProduct().then(function (responsep) {
                ...
                if ($scope.AddproductList.length > 0 && $scope.productList.length > 0) {
                    ...
                    if (r == true) {
                        orderReturnService.PostProduct($scope.AddproductList).then(function (response) {
            ...
            alert("Failed to get OrderReturnObj Detail!");
        })
